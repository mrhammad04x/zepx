...
//     const itemImgSectionRef = useRef(null);
//     const itemAboutSectionRef = useRef(null);
//     const [isSticky, setIsSticky] = useState(false);

//     useEffect(() => {
//         const handleScroll = () => {
//             if (itemImgSectionRef.current && itemAboutSectionRef.current) {
//                 const imgSectionRect = itemImgSectionRef.current.getBoundingClientRect();
//                 const aboutSectionRect = itemAboutSectionRef.current.getBoundingClientRect();
//                 const imgSectionHeight = imgSectionRect.height;
//                 const aboutSectionHeight = aboutSectionRect.height;

//                 // Check if the about section hasn't completely aligned with image section yet
//                 if (aboutSectionHeight > imgSectionHeight) {
//                     // Calculate when the bottom of the about section aligns with the bottom of the image section
//                     const imgSectionBottom = imgSectionRect.bottom;
//                     const aboutSectionBottom = aboutSectionRect.bottom;
                    
//                     // Make it sticky until the about section bottom reaches the image section bottom
//                     setIsSticky(aboutSectionBottom > imgSectionBottom);
//                 } else {
//                     setIsSticky(true); // Keep it sticky if about section is shorter
//                 }
//             }
//         };
...
//                         <div className={`item-img-section ${isSticky ? 'sticky' : ''}`} ref={itemImgSectionRef}>
...
//                             </div>
//                         </div>
//                         <div className='item-about-section' ref={itemAboutSectionRef}>
